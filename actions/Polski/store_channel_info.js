...
name: "Pobierz informacje kanalu",
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="3">Tytuł kanału</option>
			<option value="4">Ostatnia wiadomość kanału</option>
			<option value="5">Pozycja kanału</option>
			<option value="6">Jest NSFW?</option>
			<option value="7">Jest DM?</option>
			<option value="8">Można usunąć kanał?</option>
			<option value="9">Data utworzenia kanału</option>
			<option value="10">Nazwa kategorii kanału</option>
		</select>
	</div>
</div><br>
<div>
