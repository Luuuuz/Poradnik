...
<div>
	<p>
		Ta akcja była modyfikowana przez DBM Mods i tłumaczona przez Meffiu#9999
	</p>
</div>
<div style="float: left; width: 50%; padding-top: 16px;">
	...
	Nazwa Autora:<br>
	<input id="author" class="round" type="text" placeholder="Puste by usunąć"><br>
	URL Autora:<br>
	<input id="authorUrl" class="round" type="text" placeholder="Puste by usunąć"><br>
	Ikona URL Autora:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Puste by usunąć"><br>
</div>
<div style="float: right; width: 50%; padding-top: 16px;">
	Kolor:<br>
	<input id="color" class="round" type="text" placeholder="Puste by domyślnie"><br>
	URL:<br>
	<input id="url" class="round" type="text" placeholder="Puste by usunąć"><br>
	URL Zdjęcia:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Puste by usunąć"><br>
	URL Miniaturki:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Puste by usunąć"><br>
</div>
<div style="float: left; width: 94%;">
	...
	<select id="timestamp" class="round" onchange="glob.onChange(this)">
		...
		<option value="custom">Data własna</option>
	</select>
</div>
...
<div id="note1" style="float: left; padding-top: 8px; width: 100%; display: none;">
	...
	<p>
		To ustawienie działa z formatami czasu takimi jak „March 03, 1973 11:13:00” lub „100000000000” (milisekundy).<br>
	</p>
</div>
