...
<div style="width: 550px; height: 350px; overflow-y: scroll;">
	...
	<div style="width: 95%; padding-top: 8px;">
		Film do wyszukania:<br>
		<textarea id="video" rows="2" placeholder="Wpisz ID filmu, albo użyj zmiennej..." style="width: 95%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
	 </div>
	<div style="width: 95%; padding-top: 8px;">
		Info:<br>
		<select id="info" class="round">
			<option value="0">ID filmu</option>
			<option value="1">URL filmu</option>
			<option value="2">Tytuł filmu</option>
			<option value="3">Opis filmu</option>
			<option value="4">Twórca filmu</option>
			<option value="5">ID Twórcy filmu</option>
			<option value="6">URL miniaturki filmu</option>
			<option value="7">EmbedURL filmu</option>
			<option value="8">Gatunek filmu</option>
			<option value="9">Opłacony film</option>
			<option value="10">Niepubliczny?</option>
			<option value="11">FamilyFriendly?</option>
			<option value="12">Czas trwania (hh:mm:ss)</option>
			<option value="13">Wyświetlenia filmu</option>
			<option value="14">Regiony dozwolone filmu</option>
			<option value="15">Ilość komentarzy filmu</option>
			<option value="16">Łapki w góre</option>
			<option value="17">Łapki w dół</option>
			<option value="18">Baner Twórcy filmu</option>
		</select>
	</div>
	<div>
