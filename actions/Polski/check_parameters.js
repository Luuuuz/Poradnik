...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			...
			<option value="1">Liczba oznaczonych użytkowników jest...</option>
			<option value="2">Liczba oznaczonych kanałów jest...</option>
			<option value="3">Liczba oznaczonych ról jest...</option>
		</select>
	</div>
