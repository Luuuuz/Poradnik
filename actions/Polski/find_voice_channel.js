...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			...
			<option value="1">Nazwe Kanału głosowego</option>
			<option value="2">Pozycje Kanału głosowego</option>
			<option value="3">Limit użytkowników Kanału głosowego</option>
			<option value="4">Bitrate Kanału głosowego</option>
		</select>
	</div>
