...
<div style="float: right; width: 50%; padding-top: 8px;">
	...
	<select id="loop" class="round">
		<option value="0" selected>Zapętl całą kolejkę</option>
		<option value="1">Zapętl aktualny utwór</option>
	</select><br>
</div>
<div style="float: left; width: 100%; padding-top: 8px;">
	<p>
		Proszę umieścić akcję "Welcome" w zdarzeniu inicjalizacji bota, aby móc przechowywać bieżącą piosenkę!
	</p>
</div>`;
},
