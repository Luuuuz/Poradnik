...
module.exports = {
	...
	name: "Przetworz z zapisanej strony",
	...
	html: function(isEvent, data) {
		...
		<div>
			<p>
				...
				Zwraca tablicę wartości, pamiętaj o przeczytaniu swojego Terminalu/Logów bota<br> 
				podczas konstruowania polecenia z włączonym <b>Trybem debugowania</b>. 
			<p>
				<u>Instrukcja:</u><br>
					1. Wprowadź ścieżkę do obszaru tekstowego XPath<br>
					2. Test Online: <span class="wrexlink" data-url="https://codebeautify.org/Xpath-Tester">X-Path Tester</span><br>
					3. Jak zdobyć <span class="wrexlink" data-url="https://stackoverflow.com/a/46599584/1422928">XPath from Chrome.</span><br>
      ...
      <div id="sourceVarNameContainer" style="display: none; float: right; width: 60%;">
		...
		<div>			
			XPath: (Obsługuje wiele, rozdziel używając symbolu <b>|</b>) <br>
	  ...
	  <div hidden="true">
		...
		<div style="float: left; width: 30%;">
			<br>Debug Mode: (Włącz, aby zobaczyć pełne logi w konsoli)<br>
			<select id="debugMode" class="round">
		   		<option value="1" selected>Włącz</option>
