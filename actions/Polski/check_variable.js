...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="comparison" class="round" onchange="glob.onChange1(this)">
			...
			<option value="3">Jest mniejsze od</option>
			<option value="4">Jest większe od</option>
			<option value="5">Zawiera</option>
			<option value="6">Matches Regex</option>
			<option value="7">Długość jest większa od</option>
			<option value="8">Długość jest mniejsza od</option>
			<option value="9">Długość jest</option>
		</select>
	</div>
