	...
	html: function(isEvent, data) {
		...
		<div>
			<p>
				...
				Może to również służyć do zapisywania danych witryny (z wyjątkiem obrazów i plików) do zmiennej.
			</p>
			<p>
				<u>Instrukcja:</u><br>
					1. Wprowadź adres URL w polu tekstowym URL strony internetowej<br>
					2. Kliknij sprawdź URL, aby sprawdzić, czy adres URL jest prawidłowy!
			</p>
		</div>	
	  ...
	  <div>
		<button class="tiny compact ui labeled icon button" onclick="glob.checkURL(this)"><i class="plus icon"></i>Sprawdź URL</button><br>
		Poprawność: <text id="valid" style="color: red">Wpisz URL</text>
	  </div><br>
		...
		const {glob, document} = this;
			...
			try {
				...
				glob.checkURL = function(element){
					...
					if(checkedUrl && pUrl){
						valid.innerHTML = "Poprawny format URL!";
						valid.style.color = "green";
					}else{
						valid.innerHTML = "Niepoprawny format URL!";
