...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			...
			<option value="1">Nazwe Kategorii</option>
		</select>
	</div>
...
<p>Możesz pobierać informacje i edytować kategorie używając akcji "Store Category Info", "Edit Channel" lub "Set Channel Permission".</p>
