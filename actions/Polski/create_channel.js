...
ID Kategorii:<br>
<input id= "categoryID" class="round" type="text" placeholder="Zostaw puste jeśli nie chcesz wstawić kanału do kategorii" style="width: 95%"><br>
