module.exports = {
    ...
    name: "Komenda randomowy mem ksoft",
    ...
    html: function(isEvent, data) {
        ...
        <div>
            <p>
                ...
                Pojedyńcza akcjo-komenda, która zwróci losowy mem z ksoft w wiadomości embed!
            </p>
            <textarea id="key" rows="2" placeholder="Wpisz swój klucz. Weź jeden z Ksoft" style="width: 95%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
            <p>Możesz wziąć klucz api stąd:
    ...
    action: function(cache) {
        ...
        .setTitle(res.title)
        .setFooter('Modyfikowane przez Meffiu#9999')
            );
        })      
    },
