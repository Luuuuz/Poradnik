module.exports = {
  ...
  //---------------------------------------------------------------------
    ...
    short_description: "Ten mod umożliwia interakcję z plikami i katalogami. Zachowaj ostrożność podczas korzystania z tej akcji. Jeśli usuniesz plik, nie będzie już powrotu.",
  ...
  <div style="padding-bottom: 100px; padding: 0px 10px 5px 5px">
      ...
      <div style="display: flex; flex-direction: row;">
        <div class="col-20l" style="display: flex; flex-direction: column; flex: 2; padding-right: 1%;">
          ...
          <select id="format" class="round">
            <option value="" selected>INNY</option>
        ...
        <div class="col-17l" style="display: flex; flex-direction: column; flex: 2; padding-right: 1%;">
          ...
          <select id="filetask" title="99% of the time, you want append" class="round">
            <option value="0" title="Tworzy tylko plik">Stwórz</option>
            <option value="1" title="Zastępuje zawartość plików twoją">Napisz</option>
            <option value="2" title="Dodaje zawartość na końcu pliku" selected>Dodaj</option>
            <option value="3" title="Usuwa plik, BĄDŹ BARDZO ostrożny z tą opcją">Usuń</option>
          </select>
        </div>
        <div style="display: flex; flex-direction: column; flex: 8;">
          Nazwa pliku:<br>
          <textarea id="filename" title="Jeśli wybrałeś "INNY" dodaj plik .format na końcu nazwy pliku" placeholder="Przykład nazwy pliku 'mojnaprawdefajnyplik'" class="round" type="textarea" rows="1"></textarea>
        </div>
      </div>
    </div>
    ...
    <div style="padding: 5px 10px 5px 5px">
        <div style="float: left; width: 100%;">
          Ścieżka pliku:<br>
          <textarea class="round col-100" id="filepath" title="./ reprezentuje katalog główny bota. Zamiast bezwzględnej ścieżki użyj> C:/path/to/bot/" placeholder="Przykładowa ścieżka = ./logs/date/example-date/" class="round" type="textarea" rows="3"></textarea><br>
        </div>
    </div>
    
    <div style="padding: 5px 10px 5px 5px">
      <div>
        <span>Jeśli chcesz utworzyć katalog, pozostaw puste pole nazwy pliku, ustaw formatu na "INNY" i zadanie na "Stwórz".</span>
      </div>
    </div>
    ...
    <div style="padding: 5px 10px 5px 5px">
      <div id="inputArea" class="" style="float: left; width: 100%;">
        Wprowadź tekst:<br>
        <textarea id="input" placeholder="Pozostaw puste dla braku" class="round" type="textarea" rows="10"></textarea><br><br><br><br><br><br><br><br><br><br><br>
      </div>
    </div>
