...
<div style="padding-top: 8px;">
	<div style="float: left; width: 70%;">
		Max użyć:<br>
		<input id="maxUses" class="round" type="text" placeholder="Zostaw puste by ustawić nieskończoność!"><br>
		Aktywność zaproszenia (w sekundach):<br>
		<input id="lifetime" class="round" type="text" placeholder="Zostaw puste by ustawić na zawsze!"><br>
	</div>
	<div style="float: right; width: 30%;">
		Tymczasowe zaproszenie:<br>
