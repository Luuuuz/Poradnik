module.exports = {
	...
	name: "Pobierz informacje zaproszenia",
...
<div class="embed">
	...
	<div style="padding-top: 8px;">
		Zaproszenie:<br>
		<textarea class="round" id="invite" rows="1" placeholder="Kod albo URL | np. abcdef lub discord.gg/abcdef" style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
	</div><br>
	<div style="padding-top: 8px; width: 70%;">
		Info:<br>
		<select id="info" class="round">
			<option value="0" selected>Objekt kanału</option>
			<option value="1">Twórca zaproszenia</option>
			<option value="2">Data utworzenia zaproszenia</option>
			<option value="3">Data końca ważności</option>
			<option value="4">Objekt serwera</option>
			<option value="5">Max użyć</option>
			<option value="6">Jest tymczasowe?</option>
			<option value="7">URL zaproszenia</option>
