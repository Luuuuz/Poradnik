...
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
		Sprawdź czy użytkownik:<br>
		<select id="info" class="round">
			<option value="0" selected>Jest botem</option>
			<option value="2">Można wyrzucić?</option>
			<option value="1">Można zbanować?</option>
			<option value="4">Jest na kanale głosowym?</option>
			<option value="5">Można zarządzać?</option>
      <option value="6">Jest twórcą bota?</option>
		</select>
	</div>
