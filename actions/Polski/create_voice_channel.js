...
ID Kategorii:<br>
<input id= "categoryID" class="round" type="text" placeholder="Zostaw puste jeśli nie chcesz dodać kanału do kategorii" style="width: 95%"><br>

<div style="float: left; width: 50%;">
	Bitrate:<br>
	<input id="bitrate" class="round" type="text" placeholder="Zostaw puste by ustawić domyślnie!" style="width: 90%;"><br>
</div>

<div style="float: right; width: 50%;">
	Limit użytkowników:<br>
	<input id="userLimit" class="round" type="text" placeholder="Zostaw puste by ustawić domyślnie!" style="width: 90%;"><br>
</div>
