module.exports = {
	...
	name: "Pobierz info YT/Playlista",
...
<div style="width: 550px; height: 350px; overflow-y: scroll;">
	...
	<div style="width: 30%; padding-top: 8px;">
		...
		<select id="type" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Film</option>
			<option value="1">Playlista</option>
		</select>
	</div>
	...
	<div style="float: left; width: 90%; padding-top: 8px;">
		<span id="tempName">Film</span> do wyszukania:<br>
		<textarea id="url" rows="2" placeholder="Wstaw tutaj link lub zmienną." style="width: 95%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
	</div>
	<div id="divinfo0"; style="float: left; width: 85%; padding-top: 8px;">
		Informacja o filmie:<br>
		<select id="info0" class="round">
			<option value="0">ID Filmu</option>
			<option value="1" selected>URL Filmu</option>
			<option value="2">Tytuł Filmu</option>
			<option value="3">Opis Filmu</option>
			<option value="4">Właściciel Filmu</option>
			<option value="5">ID Kanału</option>
			<option value="6">URL Miniaturki</option>
			<option value="7">URL Embedu Filmu</option>
			<option value="8">Rodzaj Filmu</option>
			<option value="9">Film jest płatny?</option>
			<option value="10">Film jest niepubliczny?</option>
			<option value="11">Czy film jest family friendly?</option>
			<option value="12">Czas Filmu</option>
			<option value="13">Wyświetlenia Filmu</option>
			<option value="14">Dozwolone regiony</option>
			<option value="15">Ilość komentarzy</option>
			<option value="16">Ilość polubień</option>
			<option value="17">Ilość niepolubień</option>
			<option value="18">URL Banneru kanału</option>
		</select>
	</div>
	<div id="divinfo1"; style="float: left; width: 85%; padding-top: 8px;">
		Informacja o Playlistcie:<br>
		<select id="info1" class="round">
			...
			<option value="7">Data publikacji filmów</option>
			<option value="8">Miniaturki (Normalne)</option>
	...
	<div id="divapikey" style="float: left; width: 95%; padding-top: 8px;">
		Klucz API::<br>
		<input id="apikey" class="round" type="text" placeholder="Wstaw swój YouTube Data V3 Klucz API...">
	</div>
	<div id="divresults" style="float: left; width: 95%; padding-top: 8px;">
		Maksymalnie wyników:<br>
		<input id="results" class="round" type="text" placeholder="Zostaw puste by ustawić 100">
	</div>
	<div>
