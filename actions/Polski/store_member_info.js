...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Objekt użytkownika</option>
			<option value="1">ID użytkownika</option>
			<option value="2">Pseudonim użytkownika</option>
			<option value="3">Nazwa użytkownika</option>
			<option value="20">Discrim użytkownika (#XXXX)</option>
			<option value="22">Tag użytkownika (Nazwa#XXXX)</option>
			<option value="4">Kolor użytkownika</option>
			<option value="14">Gra użytkownika</option>
			<option value="15">Status użytkownika</option>
			<option value="16">URL awataru użytkownika</option>
			<option value="5">Serwer użytkownika</option>
			<option value="18">Data dołączenia użytkownika</option>
			<option value="21">Data utworzenia konta użytkownika</option>
			<option value="19">Kanał głosowy użytkownika</option>
			<option value="6">Ostatnia wiadomość użytkownika</option>
			<option value="17">Lista roli użytkownika</option>
			<option value="7">Najwyższa rola użytkownika</option>
			<option value="8">Rola hoist użytkownika</option>
			<option value="9">Kolor roli użytkownika</option>
			<option value="10">Jest online?</option>
			<option value="11">Jest wyciszony?</option>
			<option value="12">Jest zagłuszony?</option>
			<option value="13">Można zbanować?</option>
		</select>
	</div>
</div><br>
<div>
