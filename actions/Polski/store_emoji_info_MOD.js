module.exports = {
	...
	<div>
		<div style="padding-top: 8px; width: 70%;">
			...
			<option value="0" selected>Objekt emotki</option>
			<option value="1">Czy jest animowana?</option>
			<option value="2">Data stworzenia emotki</option>
			<option value="6">Znak czasu emotki (Timestamp)</option>
			<option value="3">Nazwa emotki</option>
			<option value="4">URL emotki</option>
			<option value="5">ID emotki</option>
			<option value="7">Czy można usunąć emotke?</option>
			<option value="8">Emotka została usunięta?</option>
			<option value="9">Server Emotki</option>
			<option value="10">Identyfikator emotki</option>
			<option value="11">Emotka jest zarządzana przez zewnętrzną usługę?</option>
			<option value="12">Emotka wymaga otaczania jej przez kolonistów?</option>
			</select>
		</div>
	</div><br>
	<div>
		...
		<div id="varNameContainer2" style="float: right; width: 60%;">
			...
			<div id="comment" style="padding-top: 30px; padding-top: 8px;">
				<p>
				Działa tylko z emotkami niestardowymi! (Dodanymi przez użytkowników)<br>
		</div>
	</div>`
	},
	//display: none;
